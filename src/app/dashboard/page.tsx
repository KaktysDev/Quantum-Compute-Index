  ...
  return (
    <div className="console-page overview-page">
      <div className="console-page-heading overview-heading">
        <div><p className="qr-eyebrow"><span /> QCI / USD-NQH</p><h1>Compute index</h1><p>Normalized quantum compute cost across the connected provider market.</p></div>
        <Link href="/dashboard/playground" className="console-primary"><Play size={14} fill="currentColor" /> New deployment</Link>
      </div>
      ...
      <nav className="qci-console-links" aria-label="Playground system views">
        <Link href="/dashboard/playground/routing"><Route size={15} /><span><b>Routing fabric</b><small>Policy, constraints, and candidate scoring</small></span><ArrowRight size={13} /></Link>
        <Link href="/dashboard/playground/api"><Terminal size={15} /><span><b>API endpoint</b><small>Authentication and request contracts</small></span><ArrowRight size={13} /></Link>
        <Link href="/dashboard/playground/network"><Cpu size={15} /><span><b>Compute network</b><small>Providers, queues, fidelity, and rates</small></span><ArrowRight size={13} /></Link>
      </nav>
    </div>
  );
}
