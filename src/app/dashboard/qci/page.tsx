...
export default async function QciPage() {
  ...
  return <div className="console-page overview-page">
    ...
    <nav className="qci-console-links" aria-label="Console system views"><Link href="/dashboard/routing"><Route size={15} /><span><b>Routing fabric</b><small>Policy, constraints, and candidate scoring</small></span><ArrowRight size={13} /></Link><Link href="/dashboard/api-keys"><Terminal size={15} /><span><b>API endpoint</b><small>Authentication and request contracts</small></span><ArrowRight size={13} /></Link><Link href="/dashboard/providers"><Cpu size={15} /><span><b>Compute network</b><small>Providers, queues, fidelity, and rates</small></span><ArrowRight size={13} /></Link></nav>
  </div>;
}
