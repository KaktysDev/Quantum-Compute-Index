...
export default async function RankingsPage() {
  ...
  return <div className="console-page rankings-page">
    <div className="console-page-heading compact"><div><h1>Rankings</h1></div><Link className="console-primary" href="/dashboard/providers">Browse providers <ArrowRight size={13} /></Link></div>
