...
const snippets = {
  ...
  cURL: `curl -X POST https://api.qrouter.app/v1/jobs \\\n  -H "Authorization: Bearer $QROUTER_API_KEY" \\\n  -H "Content-Type: application/json" \\\n  -d '{"circuit":"OPENQASM 3;…","routing":{"policy":"balanced","failover":true},"shots":1024}'`,
};
...
export function ApiWorkbench() {
  ...
  return <div className="qr-api-workbench">
    ...
    <footer><span>TRANSPILE <b>✓</b></span><span>ROUTE <b>✓</b></span><span>FAILOVER READY</span><span>NORMALIZED RESULT <b>✓</b></span></footer>
  </div>;
}
