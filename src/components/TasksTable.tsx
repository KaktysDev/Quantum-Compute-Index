...
export default function TasksTable() {
  ...
  return <div className="console-panel tasks-panel">
    ...
    {jobs.length === 0 ? <div className="console-empty"><Clock/><p>No tasks yet</p><a href="/dashboard/submit">Submit your first circuit</a></div> : jobs.map((job) => <div className="task-wrap" key={job.id}>
